...
public class Reporting extends TestListenerAdapter
{
	...
	public void onTestFailure (ITestResult result)
	{
		...
		test.log(Status.FAIL, "Test case "+ result.getName()+" is failed because the assertion condition failed");
		test.log(Status.FAIL, "Screenshot taken, please click on screenshot to maximize");
